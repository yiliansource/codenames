...
export const CardGrid: FunctionComponent<CardGridProps> = ({ cards, onClick }) => <div
    className="grid grid-cols-5 grid-rows-5 gap-4 rounded-2xl ring-1 ring-white ring-opacity-25 p-8 py-6 mx-6 my-8 2xl:mx-16 shadow">
...
export const CardComponent: FunctionComponent<CardProps> = ({ card, onClick }) => {
    ...
    if (card.isConsumed) {
        switch (card.colour) {
            ...
            case TeamColour.Black: backgroundColour = "bg-gray-600"; underlayColour = "bg-gray-700"; break;
